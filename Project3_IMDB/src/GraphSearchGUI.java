...
public class GraphSearchGUI extends Application {
     ...
     */
    private void searchAndUpdateGUI(Graph graph, ListView<String> actorsList1, ListView<String> actorsList2, ListView<String> resultsList, Label resultsLabel) {
        if (!actorsList1.getSelectionModel().isEmpty() && !actorsList2.getSelectionModel().isEmpty()) {
            ...
            List<Node> shortestPath = _searchEngine.findShortestPath(graph.getNodeByName(actor1), graph.getNodeByName(actor2));
